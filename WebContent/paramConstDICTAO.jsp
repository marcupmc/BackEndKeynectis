			...
			<div class="pull-left">
				<div class="well">
					<p>
						...
						chemin vers les certificats utilisés<br> -> Le répertoire de
						stockage des fichiers temporaires du processus<br> ->
						L'adresse du serveur de stockage des fichiers certifiés<br> <br>
