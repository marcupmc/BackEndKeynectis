			...
			HttpServletResponse response) throws ServletException, IOException
	{
		...
		else
		{
			if (!password.equals(confirm))
				messageErreur = "missmatch_pwd";// Renvoyer vers une page
												// d'erreur
			// et ajouter le nouveau Client dans la base
			// EN faisant appel a un controlleur qui va verifier la coherence
			// des entrees
		...
		// request.getRequestDispatcher("addClient.jsp?msg="+messageErreur+"").forward(request,
		// response);
