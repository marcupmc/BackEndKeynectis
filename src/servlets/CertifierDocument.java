...
public class CertifierDocument extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("adresse : "+this.getServletContext().getRealPath("/temp_xml")); 
		...
		HashMap<String, String> toReturn = ControllerCertification.getInstance().certificationPDF("MGregoire", "http://www.marc-gregoire.fr/pdf/cv.pdf", basePath,saveFile,certFolder);
